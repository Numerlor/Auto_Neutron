...
_BASE_FSDS = {  # base unengineered FSDs
    ...
    "int_hyperdrive_oversize_size2_class1": FrameShiftDrive(2, 1, 0.60, 60),
    "int_hyperdrive_oversize_size2_class2": FrameShiftDrive(2, 2, 0.90, 90),
    "int_hyperdrive_oversize_size2_class3": FrameShiftDrive(2, 3, 0.90, 90),
    "int_hyperdrive_oversize_size2_class4": FrameShiftDrive(2, 4, 0.90, 90),
    "int_hyperdrive_oversize_size2_class5": FrameShiftDrive(2, 5, 1.00, 100),
    "int_hyperdrive_oversize_size3_class1": FrameShiftDrive(3, 1, 1.20, 100),
    "int_hyperdrive_oversize_size3_class2": FrameShiftDrive(3, 2, 1.80, 150),
    "int_hyperdrive_oversize_size3_class3": FrameShiftDrive(3, 3, 1.80, 150),
    "int_hyperdrive_oversize_size3_class4": FrameShiftDrive(3, 4, 1.80, 150),
    "int_hyperdrive_oversize_size3_class5": FrameShiftDrive(3, 5, 1.90, 167),
    "int_hyperdrive_oversize_size4_class1": FrameShiftDrive(4, 1, 2.00, 350),
    "int_hyperdrive_oversize_size4_class2": FrameShiftDrive(4, 2, 3.00, 525),
    "int_hyperdrive_oversize_size4_class3": FrameShiftDrive(4, 3, 3.00, 525),
    "int_hyperdrive_oversize_size4_class4": FrameShiftDrive(4, 4, 3.00, 525),
    "int_hyperdrive_oversize_size4_class5": FrameShiftDrive(4, 5, 3.20, 585),
    "int_hyperdrive_oversize_size5_class1": FrameShiftDrive(5, 1, 3.30, 700),
    "int_hyperdrive_oversize_size5_class2": FrameShiftDrive(5, 2, 5.00, 1050),
    "int_hyperdrive_oversize_size5_class3": FrameShiftDrive(5, 3, 5.00, 1050),
    "int_hyperdrive_oversize_size5_class4": FrameShiftDrive(5, 4, 5.00, 1050),
    "int_hyperdrive_oversize_size5_class5": FrameShiftDrive(5, 5, 5.20, 1175),
    "int_hyperdrive_oversize_size6_class1": FrameShiftDrive(6, 1, 5.30, 1200),
    "int_hyperdrive_oversize_size6_class2": FrameShiftDrive(6, 2, 8.00, 1800),
    "int_hyperdrive_oversize_size6_class3": FrameShiftDrive(6, 3, 8.00, 1800),
    "int_hyperdrive_oversize_size6_class4": FrameShiftDrive(6, 4, 8.00, 1800),
    "int_hyperdrive_oversize_size6_class5": FrameShiftDrive(6, 5, 8.30, 2000),
    "int_hyperdrive_oversize_size7_class1": FrameShiftDrive(7, 1, 8.50, 1800),
    "int_hyperdrive_oversize_size7_class2": FrameShiftDrive(7, 2, 12.80, 2700),
    "int_hyperdrive_oversize_size7_class3": FrameShiftDrive(7, 3, 12.80, 2700),
    "int_hyperdrive_oversize_size7_class4": FrameShiftDrive(7, 4, 12.80, 2700),
    "int_hyperdrive_oversize_size7_class5": FrameShiftDrive(7, 5, 13.10, 3000),
}
